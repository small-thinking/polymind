...
class OpenAICompatibleLLMTool(LLMTool):
    """OpenAICompatibleLLMTool is a tool to leverage any OpenAI compatible API to do LLM inference"""

    model_config = {
        "arbitrary_types_allowed": True,  # Allow arbitrary types
    }
    tool_name: str = "llm-tool"
    descriptions: List[str] = [
        "This tool is used to leverage the Groq API to do LLM inference.",
        "This tool can be used to generate the response from the Groq Llama3-70b LLM.",
        "This tool can be used to generate the code of new tools.",
    ]
    llm_name: str = Field(default="llama3-70b-8192", description="The name of the LLM model.")
    system_prompt: str = Field(default="You are a helpful AI assistant.")
    max_tokens: int = Field(default=4096, description="The maximum number of tokens for the chat.")
    temperature: float = Field(default=0.7, description="The temperature for the chat.")
    ...
    api_type: str = Field(default="groq", description="The type of the API to use. Choices: openai, groq")
